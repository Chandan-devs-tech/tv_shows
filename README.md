...
- cd Desktop
- git clone https://github.com/Chandan-devs-tech/tv_shows.git
...
Feel free to check the [issues page](https://github.com/Chandan-devs-tech/tv_shows/issues)
...
I would like to thank [QuabBTECH](https://quadbtech.com/)
